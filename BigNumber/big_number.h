...
/*
* @brief Произведение двух больших чисел
* @param bn1_, bn2_ : Большие числа
* @return Большое число из произведение двух входных
*/
BigNumber* MultBN(BigNumber* bn1_, BigNumber* bn2_);

/*
* @brief Частное двух больших чисел
* @param bn1_, bn2_ : Большие числа
* @return Большое число из деления двух входных
*/
...
* @param bn1_, bn2_ : Большие числа
* @return 1 - первое больше, -1 - второе больше, 0 - равны 
*/
